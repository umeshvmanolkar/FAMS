...
public class ImagePicker {
    ...
    public static Intent getPickImageIntent(Context context, String message) {
       ...
       // takePhotoIntent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(getTempFile(context)));
        takePhotoIntent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(createImageFiles("metaldata")));
    ...
    public static Bitmap getImageFromResult(Context context, int resultCode,
        ...
        File imageFile = createImageFiles("metaldata");
    ...
    private static File createImageFiles(String fileName){
